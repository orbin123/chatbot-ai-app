...
export default async function ViewChatbots() {
  ...
  return (
    <div className="flex-1 pb-20 p-10">
      ...
      <div>
        <p>You have not created any chatbots yet, click on the button below to create</p>
            ...
            <div className="grid grid-cols-2 gap-10 md:gap-5">
              ...
              <ul>
                ...
                {chatbot.chatbot_characteristics.map((characteristic) => (
                  <li className="list-disc break-words" key={characteristic.id}>{characteristic.content}</li>
                ))}
              </ul>
